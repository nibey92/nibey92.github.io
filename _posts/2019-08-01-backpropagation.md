...
다만 역전파 1단계와는 달리 우변의 첫번째 항인 $$\frac{\partial E_{tot}}{\partial h_1}$$ 에 대해서 추가적으로 chain rule을 이용하여 계산을 해주어야 합니다. 하지만 두번째 항과 세번째 항의 미분값은 o_1과 h_1을 각각 h_1과 x_1로 치환하기만 하면 됩니다. 따라서 첫번째 항을 제외한 두번째 세번째 항의 미분 결과를 사용하면 
